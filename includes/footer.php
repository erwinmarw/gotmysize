<footer class="bg-gray-800 mt-auto">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <!-- Company Info -->
            <div>
                <h3 class="text-white text-lg font-bold mb-4">gotmysize!</h3>
                <p class="text-gray-400 text-sm">
                    Your one-stop destination for authentic sneakers and streetwear.
                </p>
            </div>

            <!-- Shop -->
            <div>
                <h4 class="text-white text-sm font-semibold mb-4">SHOP</h4>
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white text-sm">Release Calendar</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white text-sm">Brands</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white text-sm">Shipping Info</a></li>
        ...
        <div class="mt-8 pt-8 border-t border-gray-700">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <!-- Copyright -->
                <p class="text-gray-400 text-sm">
                    &copy; <?php echo date('Y'); ?> gotmysize! All rights reserved.
                </p>
            </div>
        </div>
    </div>
